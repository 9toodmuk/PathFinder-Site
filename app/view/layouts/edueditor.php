...
<div id="edueditor" class="form-group col-md-12" style="border: 1px solid #eee; padding: 10px;">
  <form id="eduform" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
    <div class="form-group">
        <label for="" class="col-sm-2 control-label">ชื่อสถาบัน</label>
        <div class="col-sm-10">
          <input type="text" name="institute_name" id="institute_name" class="form-control" value="" placeholder="ชื่อสถาบัน" required>
        </div>
    </div>

    <div class="form-group">
        <label for="" class="col-sm-2 control-label">ระดับ</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <label for="" class="col-sm-2 control-label">วิชาเอก/สาย</label>
        <div class="col-sm-10">
          <input type="text" name="major" id="major" class="form-control" value="" placeholder="วิชาเอก/สาย" required>
        </div>
    </div>

    <div class="form-group">
        <label for="" class="col-sm-2 control-label">เกรดเฉลี่ย</label>
        <div class="col-sm-10">
          <input type="number"  step="0.01" min="0.00" name="gpa" id="gpa" class="form-control" value="" placeholder="เกรดเฉลี่ย" required>
        </div>
    </div>

    <div class="form-group">
      <div class="col-md-12 text-center">
        <button id="btnEduEdit" type="submit" class="btn btn-primary" data-loading-text="<?=$lang['processing']?>">อัพเดท</button>
        <button id="btnEduCancel" type="button" class="btn btn-default">ยกเลิก</button>
      </div>
